...
#define FLAG_RECEIVED_FROAKIE    0x20 // test script for froakie event
...
#define FLAG_DAILY_STARZONE_BERRY_RECEIVED          (DAILY_FLAGS_START + 0x0)  // used for starzone gateway berry woman event
#define FLAG_DAILY_CONTEST_LOBBY_RECEIVED_BERRY     (DAILY_FLAGS_START + 0x1)
#define FLAG_DAILY_SECRET_BASE                      (DAILY_FLAGS_START + 0x2)
#define FLAG_DAILY_STARZONE_SAFARI_ATTEMPTED        (DAILY_FLAGS_START + 0x3)  // used for starzone safari attempt

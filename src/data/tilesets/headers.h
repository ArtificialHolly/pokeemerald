...
const struct Tileset gTileset_TenkyuuCity =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_TenkyuuCity,
    .palettes = gTilesetPalettes_TenkyuuCity,
    .metatiles = gMetatiles_TenkyuuCity,
    .metatileAttributes = gMetatileAttributes_TenkyuuCity,
    .callback = NULL,
};

...
const u16 gMetatiles_TenkyuuCity[] = INCBIN_U16("data/tilesets/secondary/tenkyuu_city/metatiles.bin");
const u16 gMetatileAttributes_TenkyuuCity[] = INCBIN_U16("data/tilesets/secondary/tenkyuu_city/metatile_attributes.bin");
